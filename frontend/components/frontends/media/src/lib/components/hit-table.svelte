<script lang="ts" module>
	...
	import { relevanceOf, isVoiceHit } from '@repo/media-api';
	import { activeView, type DatasetView } from '@repo/media-api/descriptor';
...
<script lang="ts">
	import { thumbnailUrl } from '@repo/media-api';
