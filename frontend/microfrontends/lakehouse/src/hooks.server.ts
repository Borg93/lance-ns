...
// rewrite, both single-sourced in @repo/api/bff. No-op when OIDC is unconfigured (the zone runs
...
export const handleError = makeZoneServerErrorHandler('lakehouse');
