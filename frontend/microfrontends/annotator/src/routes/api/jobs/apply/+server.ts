...
// Explicit POST route: submit a batch labeling job (producer × selection scope) — the
// annotator's bulk `apply()`. Enumerated write — bearer-forwarding, fail-closed without
// a session on an auth-enabled stack.
