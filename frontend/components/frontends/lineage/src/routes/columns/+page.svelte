<script lang="ts">
	...
	$effect(() => {
		...
		goto(`${base}/columns${q}`, { replaceState: true, keepFocus: true, noScroll: true });
	});
...
<div class="app">
	...
	{:else if !selected}
		<div class="empty pad">
			<p>
				Pick a dataset above (or open one from <a href="{base}/datasets">Datasets</a> and follow “column
