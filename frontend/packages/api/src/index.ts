// @repo/api — shared frontend data layer, split by domain. JIT TS: apps import the source directly
...
//   • @repo/api/oidc — the OIDC crypto seam (PKCE, sealed AES-256-GCM session cookie).
//   • @repo/api/bff  — the SvelteKit BFF factories (makeOidcConfig / makeSessionHandle / makeBackendProxy).
export * from './gateway';
export * from './parse';
export * from './me';
