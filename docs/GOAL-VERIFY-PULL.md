...
| **Annotate as projects** | Annotate should be project/batch-driven — items arrive by being SENT from search or elsewhere, not picked from a gallery of the whole corpus | #122 | NOT STARTED — product-shape decision on the project model needed first. What exists is a 1154-document / 49-page gallery |
